...
+ (NSString *)imx_localDisplayNameForCC:(NSString *)cc lan:(NSString *)lan{
    NSLocale *currentLocale = nil;
    if(lan){
        currentLocale = [NSLocale localeWithLocaleIdentifier:lan];//en
    }else{
        currentLocale = [NSLocale currentLocale];
    }
    NSString *displayNameString = [currentLocale displayNameForKey:NSLocaleCountryCode value:cc];
